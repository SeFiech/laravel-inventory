                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group{{ $errors->has('stock_defective') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="number" name="stock_min" id="input-stock_min" class="form-control form-control-alternative" placeholder="Defective Stock" value="{{ old('stock_min', $product->stock_min) }}" required>
